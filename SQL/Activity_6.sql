...
select purchase_amount from orders order by order_date desc;

select order_no,order_date,customer_id,salesman_id,purchase_amount from orders where purchase_amount < 500;

select order_no,order_date,customer_id,salesman_id,purchase_amount from orders where purchase_amount BETWEEN 1000 AND 2000;
